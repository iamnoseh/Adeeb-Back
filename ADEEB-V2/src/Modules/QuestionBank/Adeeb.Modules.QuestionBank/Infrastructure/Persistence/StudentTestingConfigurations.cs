...
internal static class StudentTestingConcurrency
{
    public static async Task AcquireUserLockAsync(QuestionBankDbContext db, Guid userId, CancellationToken ct)
    {
