...
public sealed record RegisterRequest(string Email, string Password, string FirstName, string LastName, string? Language, DeviceRequest Device);
public sealed record LoginRequest(string Email, string Password, DeviceRequest Device);
public sealed record RefreshTokenRequest(string RefreshToken);
public sealed record ChangePasswordRequest(string CurrentPassword, string NewPassword);
public sealed record UserResponse(Guid Id, string Email, string FirstName, string LastName, string PreferredLanguage);
