...
public sealed class DocumentationCoverageTests
{
    ...
    [
        ...
        ("GET", "/api/v2/commerce/me/payment-receipts", "Commerce.MePaymentReceipts"),
        ...
        ("PUT", "/api/v2/admin/commerce/tariffs/{tariffId}", "Commerce.AdminUpdateTariff"),
        ("POST", "/api/v2/admin/commerce/tariffs/{tariffId}/archive", "Commerce.AdminArchiveTariff"),
