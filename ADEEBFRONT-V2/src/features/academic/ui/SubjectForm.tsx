...
export function SubjectForm({ subjectId }: SubjectFormProps) {
  ...
  return (
    <form className="app-surface mx-auto grid w-full max-w-5xl gap-6 rounded-[2rem] p-5 md:p-7" onSubmit={(event) => void form.handleSubmit((values: SubjectFormValues) => mutation.mutate(values))(event)}>
